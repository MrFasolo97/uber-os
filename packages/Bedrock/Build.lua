...
local function install(root)
    ...
    pcall(fs.makeDir(root .. "/usr/include/bedrock"))
    pcall(fs.copy, PWD .. "/out/libbedrock.lua", root ..  "/lib/libbedrock.lua")
    pcall(fs.copy, PWD .. "/out/Bedrock.lua", root ..  "/usr/include/bedrock/Bedrock")
end
