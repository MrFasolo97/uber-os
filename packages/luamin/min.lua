...
lua_parser = lua.include('parselua')
util = lua.include('util')
local ParseLua = lua_parser.ParseLua
                                                                                                                                                        ...
                                                                                                                                                        elseif statement.AstType == 'GenericForStatement' then
                                                                                                                                                            ...
                                                                                                                                                            elseif statement.AstType == 'NumericForStatement' then
                                                                                                                                                                ...
                                                                                                                                                                elseif statement.AstType == 'LabelStatement' then
                                                                                                                                                                    ...
                                                                                                                                                                    local minify = function(code)
                                                                                                                                                                        local a, b
                                                                                                                                                                        a, b = lua_parser.ParseLua(code)
                                                                                                                                                                        if a then
                                                                                                                                                                            return Format_Mini(b)
                                                                                                                                                                        else
                                                                                                                                                                            return false
                                                                                                                                                                        end
                                                                                                                                                                    end
